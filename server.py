...
# Taula `drafts` a Supabase (veure migrations/2026-04-19_drafts.sql). Permet
# al docent desar al servidor el text del Pas 2 abans d'adaptar-lo, de manera
# que no es perdi en canviar de navegador/dispositiu. Mateix patró de crida
# que /api/history (veure save_history/list_history més avall).
