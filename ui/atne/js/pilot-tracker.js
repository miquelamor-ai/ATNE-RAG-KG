...
(function () {
  ...
  var MODAL_HTML = [
    ...
    '    <h2 style="margin:0 0 8px;font-family:Fraunces,Georgia,serif;font-size:22px;color:#1f1f2c">',
    '      Abans de continuar…',
    '    </h2>',
    '    <p style="margin:0 0 18px;color:#454555;line-height:1.45;font-size:14px">',
    '      Ens ajudes amb una valoració ràpida d\'aquesta adaptació? Només triga 5 segons',
    '      i ens permet millorar ATNE durant el pilot.',
    '    </p>',
    ...
    '              style="background:transparent;border:none;color:#6b6b7a;font-size:13px;',
    '                     cursor:pointer;text-decoration:underline">Omet</button>',
    ...
    '                     cursor:pointer">Envia i continua</button>',
    '    </div>',
    '  </div>',
    '</div>'
  ].join('');
